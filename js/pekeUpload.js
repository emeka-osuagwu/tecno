              ...
              obj.next('a').next('div').find('.pekeup-progress-bar:first').width(percent+'%');
                ...
                if (data!='Invalid file type.'){
                 ...
                 //replace default image with uploaded image
                  $('.resize-image').attr('src',imgname);
                  $('#fauxcomponent').css('display','none');
                  $('#actualcomponent').css('display','block');
                  $('#chooseFile').css("display", 'none');
                  $('#restart').css("display", "block");
                  $('body').append('<script src="js/component.js"></script>');
                  console.log("component.js called");
              
  
                    // $('div#downloadready').css('display','none');
                    // $('div#fauxbox').css('display','none');
                    // $('a.btn-upload').html('TRY ANOTHER');

                   $('#croppingbox').css('display','block');
