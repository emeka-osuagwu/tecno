                ...
                instagram: {
                    ...
                    getData: function(account) {
                        ...
                        switch (account[0]) {
                            case '@':
                                var username = account.substr(1);
                                url = Feed.instagram.api + 'users/search/?q=' + username + '&' + 'access_token=' + options.instagram.access_token + '&count=1';
                                Utility.request(url, Feed.instagram.utility.getUsers);
                                break;
                            case '#':
                                var hashtag = account.substr(1);
                                url = Feed.instagram.api + 'tags/' + hashtag + '/media/recent/?' + 'access_token=' + options.instagram.access_token + '&' + 'count=' + options.instagram.limit;
