var CROP = (function() {
    ...
    return function() {
        ...
        this.crop = function(width, height, type) {
            ...
            // canvas.getContext('2d').fillStyle = "rgba(0,0,0,0.85)";
        ...
        this.import = function() {
            var that = this;
            $('body').append('<input type="file" id="importIMG" accept="image/*" style="display:none">');
            var self = this,
                imgInfo = self.imgInfo,
                c = self.eles.container,
                img = self.eles.img;
            ...
            oFReader.onload = function(oFREvent) {
                ...
                $("#chooseFile").fadeOut();
                $('#no_image_img').addClass('hide');
                $('#restart').removeClass('hide');
                $('.doneer').removeClass('hide');
                $('#rotate').removeClass('hide');
                $('#addBlur').removeClass('hide');
            };
